...
class CloudinaryCleanupManager:
        ...
        try:
            while len(resources) < max_results:
                ...
                response = cloudinary.api.resources(
                    ...
                    prefix='rozzi/'  # Only get files in our folder
                )
    ...
    def cleanup_orphaned_files(self) -> Tuple[int, int]:
        ...
        resource_types = [
            ('image', 'rozzi/profiles'),  # Profile pictures
            ('image', 'rozzi/id_cards'),  # ID card photos
            ('raw', 'rozzi/resumes'),     # Resume files
        ]
        ...
        for resource_type, folder_prefix in resource_types:
            ...
            for resource in resources:
                ...
                if not public_id or not public_id.startswith(folder_prefix.replace('rozzi/', '')):
                    continue
