...
from payments.views import UserSubscriptionDetailView
...
urlpatterns = [
    ...
    path('auth/set-username/', SetUsernameView.as_view(), name='set_username'),
    path('token/refresh/', TokenRefreshView.as_view(), name='token_refresh'),
    path('me/', UserProfileView.as_view(), name='user_profile'),
    path('me/subscription/', UserSubscriptionDetailView.as_view(), name='me-subscription'),
    ...
    path('resume-files/signed-url/', GetResumeSignedUrlView.as_view(), name='resume-signed-url'),
    ...
    path('users/<str:user_id>/profile/', UserProfileDetailView.as_view(), name='user-profile-detail'),
    path('users/search/', UserSearchView.as_view(), name='user-search'),
    path('users/<str:user_id>/follow/', FollowView.as_view(), name='follow-user'),
    path('users/<str:user_id>/follow-status/', FollowStatusView.as_view(), name='follow-status'),
    path('users/followed/', FollowedUsersView.as_view(), name='followed-users'),
    path('users/<str:user_id>/block/', BlockView.as_view(), name='block-user'),
    path('users/<str:user_id>/block-status/', BlockStatusView.as_view(), name='block-status'),
    ...
    path('notifications/register-device/', DeviceTokenRegisterView.as_view(), name='device-register'),
    path('notifications/unregister-device/', DeviceTokenUnregisterView.as_view(), name='device-unregister'),
    ...
    path('users/<str:user_id>/can-send-message/', CanSendMessageView.as_view(), name='can-send-message'),
]
