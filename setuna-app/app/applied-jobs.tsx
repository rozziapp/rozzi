...
export default function AppliedJobsScreen() {
  ...
  const renderJobCard = (item: AppliedJob | JobPreference | HireRequest) => {
    if (activeTab === 'applied' && 'job' in item) {
      ...
      return (
        <View key={appliedJob.id} style={styles.jobCard}>
          ...
          <View style={styles.jobHeader}>
            <View style={styles.jobInfo}>
              <Text style={styles.jobTitle} numberOfLines={2}>{appliedJob.job.title}</Text>
              <Text style={styles.companyName}>{appliedJob.job.user.full_name}</Text>
              <View style={styles.jobDetailsRow}>
                <View style={styles.detailItem}>
                  <Ionicons name="location-outline" size={18} color="#ef4444" />
                  <Text style={styles.detailText} numberOfLines={1}>{appliedJob.job.location}</Text>
                </View>
                <View style={styles.detailItem}>
                  <Ionicons name="time-outline" size={18} color="#6b46c1" />
                  <Text style={styles.detailText} numberOfLines={1}>{appliedJob.job.job_type}</Text>
                </View>
              </View>
            </View>
          </View>
          ...
          <View style={styles.salaryRow}>
            ...
            <Text style={styles.salary}>{formatSalary(appliedJob.job.salary_min, appliedJob.job.salary_max)}</Text>
          </View>

          {/* Application Info Footer */}
          <View style={styles.applicationFooter}>
            <View style={styles.applicationInfo}>
              <Text style={styles.appliedDate}>Applied {getRelativeDate(appliedJob.applied_date)}</Text>
      ...
      return (
        <View key={jobPreference.id} style={styles.jobCard}>
          <View style={styles.statusBadgeTop}>
          ...
          <View style={styles.jobHeader}>
            <View style={styles.jobInfo}>
              <Text style={styles.jobTitle} numberOfLines={2}>{jobPreference.title}</Text>
              <View style={styles.categoryRow}>
                <Text style={styles.categoryText}>{jobPreference.job_type}</Text>
              </View>
            </View>
          </View>
               ...
               <View style={styles.detailItem}>
                 <Ionicons name="location-outline" size={18} color="#ef4444" />
                 <Text style={styles.detailText} numberOfLines={1}>{jobPreference.location}</Text>
               </View>
               <View style={styles.detailItem}>
                 <Ionicons name="briefcase-outline" size={18} color="#6b46c1" />
                 <Text style={styles.detailText} numberOfLines={1}>{jobPreference.category}</Text>
               </View>
             </View>
          ...
          {(jobPreference.salary_min || jobPreference.salary_max) && (
            <View style={styles.salaryRow}>
              <Text style={styles.salaryLabel}>Salary:</Text>
              <Text style={styles.salary}>{formatSalary(jobPreference.salary_min, jobPreference.salary_max)}</Text>
            </View>
          )}
          ...
          <View style={styles.jobFooter}>
            <View style={styles.metricsContainer}>
              ...
              <View style={styles.metricItem}>
                ...
                <Text style={styles.metricText} numberOfLines={1}>Posted {getRelativeDate(jobPreference.created_at)}</Text>
              </View>
            </View>
    ...
    <View style={styles.container}>
      ...
      <View style={styles.toggleContainer}>
        <TouchableOpacity
          style={[
            styles.toggleButton,
            activeTab === 'applied' && styles.activeToggleButton
          ]}
          onPress={() => setActiveTab('applied')}
        >
          <Text style={[
            styles.toggleText,
            activeTab === 'applied' && styles.activeToggleText
          ]}>
            Applied Jobs
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={[
            styles.toggleButton,
            activeTab === 'posted' && styles.activeToggleButton
          ]}
          onPress={() => setActiveTab('posted')}
        >
          <Text style={[
            styles.toggleText,
            activeTab === 'posted' && styles.activeToggleText
          ]}>
            Job Seeking
          </Text>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        {currentData.length === 0 ? (
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyStateText}>No {activeTab === 'applied' ? 'jobs' : 'job posts'} found</Text>
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={styles.applicantsModal}>
              ...
              >
                {applicants.length === 0 ? (
                  <View style={styles.emptyApplicants}>
                    ...
                    <Text style={styles.emptyApplicantsSubtext}>
                      {activeTab === 'posted' 
                      ...
                      <View style={styles.applicantHeader}>
                        ...
                        <View style={styles.applicantInfo}>
                          <View style={styles.applicantTopRow}>
                            <Text style={styles.applicantName}>{applicant.user.full_name}</Text>
                          </View>
                          <View style={styles.applicantBottomRow}>
                            <Text style={styles.applicantUsername}>@{applicant.user.username}</Text>
                            <TouchableOpacity 
